...
def create_bull_researcher(llm):
    def bull_node(state) -> dict:
        ...
        instrument_focus = (
            """- Fund thesis: Assess the strategy, underlying exposures and supporting market conditions.
- Fund structure: Use reported fees, diversification, liquidity and holdings concentration.
- Positive evidence: Distinguish fund-level metrics from the performance of portfolio companies."""
